...
from motores_compressao import (buscar_sevenzip_executavel, buscar_winrar_executavel, CompressaoRAR,
                                CompressaoZIP, Compressao7Z, CompressaoTAR, TestarIntegridade, Extracao)
from paleta_cores_design import apply_dialog_box_theme
