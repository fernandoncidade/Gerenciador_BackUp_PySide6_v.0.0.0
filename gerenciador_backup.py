...
from gerenciador_interface import GerenciadorInterface
from metodos_compressao import MetodoCompressao
from paleta_cores_design import apply_neutral_standart_theme
